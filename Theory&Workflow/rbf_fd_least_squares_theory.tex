...
For simplicity, we assume $\partial \Omega = \Gamma_D \cup \Gamma_N$ and $\Gamma_D \cap \Gamma_N = \emptyset$. Furthermore, let $g_D, g_N \in W^{k-1,p}(\partial \Omega)$. By \textit{Agmon-Douglis-Nirenberg} Theorem \cite{Agmon}, we have the following estimate for $u$:
\begin{equation}
...
The polynomial constraint setup can be viewed as a Lagrange multiplier to a minimization scheme for the weights.
