...
def rbf_fd_system(f, g_bound, btype, P, basis, shape, L, num_stencils,
    ...
    S = stencils.knn_list(P, num_stencils)
...
if __name__ == "__main__":
    ...
    # BUILD CONTEXT
    # -----------------------------
    context = PDEDomainContext(P)
    context.set_stencils(stencils.knn_list(P, k_s))
