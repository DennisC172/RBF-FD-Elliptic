...
def reconstruction_study(context, shape, L, Amp, modes, example_problems):
    P = context.nodes
    A = context.A
    W = context.W
...
if __name__ == "__main__":
    ...
    # -----------------------------
    context = training_setup(L, Nx, Ny, shape, k_s, k_c,
                             rbf_shape, augmentation, eps,
    ...
    reconstruction_setup(context, shape, L, Amp, modes, example_problems)